...
Consider now a more general problem, with $k$ objects (names in our article) instead of 365 days : consider now some $\{x_1,\cdots,x_k\}$, with a uniform distribution.
